                ...
                <div class="col-md-8">
                    ...
                    <div class="card">
                        <div class="wrapper1">
                            ...
                            <div class="card-header" style="font-size:2em;">{{ __('Register') }}</div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="name" type="text"
                                                ...
                                                value="{{ old('name') }}" pattern="[A-Za-z\s]+" required autocomplete="name" autofocus>
                                    ...
                                    <div class="row mb-0">
                                        ...
                                        <br>
                                        <br>
                                        <a class="nav-link" href="{{ route('login') }}" id="ab">{{ __('Login') }}</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
